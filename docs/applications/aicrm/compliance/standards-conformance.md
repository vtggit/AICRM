...
| Deployment standard | Not aligned | No formal adoption yet | Not conforming | Containerized deployment |
...
- **Database standard**: PostgreSQL is used for `contacts`, `templates`, `leads`, `activities`, `settings`, and `audit_log` tables. Schema is auto-created on startup.
